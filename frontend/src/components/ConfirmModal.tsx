            ...
            {isOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center p-6">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-white/95 backdrop-blur-2xl rounded-[40px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.2)] border border-white/60 overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 p-10 md:p-12">
                            ...
                            <div className="flex justify-between items-start mb-8">
                                <motion.div
                                    ...
                                    className={`w-14 h-14 rounded-3xl ${theme.iconBg} flex items-center justify-center shadow-inner border border-white/50`}
                                >
                                    {theme.icon}
                                </motion.div>
                                <button
                                    onClick={onCancel}
                                    className="p-3 bg-slate-50 hover:bg-slate-100 rounded-2xl transition-all duration-200 text-slate-400 hover:text-slate-600 active:scale-90 cursor-pointer"
                                >
                                    <X size={20} />
                                </button>
                            </div>
                            ...
                            <div className="space-y-4 mb-10">
                                <h3 className="text-3xl font-bold tracking-tight text-slate-900 font-heading leading-tight">
                                    {title}
                                </h3>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    onClick={onConfirm}
                                    className={`
                                        flex-1 py-4 px-6 ${theme.primaryBtn} text-white rounded-[24px] 
                                ...
                                <button
                                    onClick={onCancel}
                                    className="
                                        flex-1 py-4 px-6 bg-slate-50 hover:bg-slate-100 text-slate-600 
                                        rounded-[24px] font-bold text-sm uppercase tracking-widest 
