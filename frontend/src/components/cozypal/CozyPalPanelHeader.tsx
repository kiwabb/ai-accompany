...
interface CozyPalPanelHeaderProps {
...
const CozyPalPanelHeader = ({
  avatarState,
  mainTab,
  onMainTabChange,
  onClose,
  t,
}: CozyPalPanelHeaderProps) => (
  <div className="flex-none p-5 pb-3 border-b border-indigo-50 bg-white/40 backdrop-blur-md">
    ...
    <div className="flex p-1.5 bg-gray-100/50 backdrop-blur-sm rounded-2xl border border-white/50">
      <button
        onClick={() => onMainTabChange('companion')}
      ...
      <button
        onClick={() => onMainTabChange('gemini')}
...
export default CozyPalPanelHeader;
