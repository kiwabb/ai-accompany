...
interface DebugPanelProps {
    ...
    setDiagnostics: React.Dispatch<React.SetStateAction<DiagnosticData | null>>;
    memoryFragments: { id: number; content: string; created_at: string }[];
    fetchMemoryFragments: () => Promise<void>;
    isDiagLoading: boolean;
    setIsDiagLoading: React.Dispatch<React.SetStateAction<boolean>>;
}
...
const DebugPanel: React.FC<DebugPanelProps> = ({
    ...
    }, [setDiagnostics, setIsDiagLoading]);
