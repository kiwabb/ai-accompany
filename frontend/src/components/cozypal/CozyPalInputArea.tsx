...
interface CozyPalInputAreaProps {
  inputRef: RefObject<HTMLInputElement | null>;
  inputValue: string;
  onInputChange: (value: string) => void;
  isLoading: boolean;
  onSend: (event: { preventDefault: () => void }) => void;
  t: TFunction;
}

const CozyPalInputArea = ({ inputRef, inputValue, onInputChange, isLoading, onSend, t }: CozyPalInputAreaProps) => (
  <form onSubmit={onSend} className="p-4 bg-gray-50/50 border-t border-gray-100 flex-none">
...
export default CozyPalInputArea;
